...
async def on_message(message):
    ...
    if message.content.startswith('!каталик шип'):
        ...
        #emb.add_field(name= 'Описание', value= 'Скорбь... Готовли ты познать всю глубину отчаяния?⁣⁣⁣⁣⁣ᅠᅠᅠᅠᅠᅠᅠᅠᅠᅠᅠᅠᅠᅠᅠᅠᅠᅠᅠᅠᅠᅠᅠᅠᅠᅠᅠᅠᅠᅠᅠᅠᅠᅠᅠᅠᅠᅠᅠᅠᅠᅠᅠᅠᅠᅠᅠᅠᅠᅠᅠᅠ')
        #emb.add_field(name= 'Условие для получения', value= 'Группой из 3 стражей, вооружившись оружеем скорби. Убить Зулмака Орудее Пыток ни разу не умеревᅠᅠᅠᅠᅠᅠᅠᅠᅠᅠᅠᅠᅠᅠᅠᅠᅠᅠᅠ')
        #emb.add_field(name= 'Задание катализатора', value= 'Убить стража в патрульной зоне, в любой точке Солнечной системыᅠᅠᅠᅠᅠᅠᅠᅠᅠᅠᅠᅠᅠᅠᅠᅠᅠᅠᅠᅠᅠᅠᅠᅠᅠᅠᅠᅠᅠᅠᅠᅠᅠᅠᅠᅠᅠ')
